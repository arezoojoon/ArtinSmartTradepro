            ...
            <Tabs defaultValue="manager" onValueChange={setActiveRole} className="w-full">
                <div className="flex justify-center mb-8">
                    <TabsList className="grid grid-cols-3 h-14 bg-black/40 backdrop-blur-xl border border-white/10 p-1 rounded-xl w-full max-w-2xl relative overflow-hidden">
                        ...
                        <TabsTrigger value="sales" className="rounded-lg font-bold data-[state=active]:bg-[#D4AF37] data-[state=active]:text-black data-[state=active]:shadow-[0_0_20px_rgba(212,175,55,0.3)] transition-all z-10 text-slate-400">
                            Sales Agent
                        </TabsTrigger>
                        <TabsTrigger value="sourcing" className="rounded-lg font-bold data-[state=active]:bg-[#D4AF37] data-[state=active]:text-black data-[state=active]:shadow-[0_0_20px_rgba(212,175,55,0.3)] transition-all z-10 text-slate-400">
                            Sourcing Agent
                        </TabsTrigger>
                    </TabsList>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <Card className="bg-black/40 backdrop-blur-xl border border-white/10 relative overflow-hidden">
                            ...
                            <CardHeader>
                                <CardTitle className="text-white text-lg flex items-center gap-2">
                                    <Target className="h-5 w-5 text-[#D4AF37]" /> Conversion Intelligence
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Progress value={38} className="h-2 bg-white/5 [&>div]:bg-[#D4AF37]/40 rounded-none" />
                                </div>
                                <div className="space-y-2">
                                    <div className="flex justify-between text-[11px] uppercase font-bold tracking-widest text-slate-400">
                                    ...
                                    <Progress value={15} className="h-2 bg-white/5 [&>div]:bg-[#D4AF37]/70 rounded-none" />
                                </div>
                                <div className="space-y-2">
                                    <div className="flex justify-between text-[11px] uppercase font-bold tracking-widest text-[#D4AF37]">
                                        <span>Won Deals</span>
                                        <span className="text-[#D4AF37]">24</span>
                                    </div>
                                    <Progress value={5} className="h-2 bg-white/5 [&>div]:bg-[#D4AF37] rounded-none shadow-[0_0_10px_rgba(212,175,55,0.4)]" />
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-black/40 backdrop-blur-xl border border-white/10">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10 group hover:border-[#D4AF37]/30 transition-all">
                                    <Clock className="h-5 w-5 text-[#D4AF37] mt-1" />
                                    <div>
                                        <p className="text-sm font-bold text-white group-hover:text-[#D4AF37]">Quote Expiration Alert</p>
                                        <p className="text-[11px] text-slate-500 mt-1">Supplier 'Zar Macaron' price validity expires <span className="text-[#D4AF37]">today</span>.</p>
                                        <Button size="sm" className="mt-4 h-8 bg-black/40 text-slate-300 border border-white/10 hover:border-[#D4AF37] font-bold text-[10px] uppercase tracking-widest">Ping Sourcing Team</Button>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                ...
                <TabsContent value="sales" className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="flex items-center gap-6">
                        <Link href="/crm/pipelines" className="flex-1">
                            <Button className="w-full bg-[#D4AF37] text-black hover:bg-white h-14 font-extrabold text-base shadow-[0_0_20px_rgba(212,175,55,0.2)]">
                                <Target className="mr-2 h-5 w-5" /> Sales Kanban Board
                            </Button>
                        </Link>
                        <Link href="/crm/campaigns" className="flex-1">
                            <Button variant="outline" className="w-full border-white/10 bg-black/40 text-white hover:bg-[#D4AF37] hover:text-black h-14 font-bold text-base transition-all">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5 group hover:border-[#D4AF37]/30 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-white group-hover:text-[#D4AF37] transition-colors">Spinneys - Procurement Director</p>
                                            <p className="text-[11px] text-slate-500 uppercase font-medium tracking-tight mt-1">Discuss pricing for Q3 Pasta shipment</p>
                                        </div>
                                    </div>
                                    <Badge className="bg-[#D4AF37]/10 text-[#D4AF37] border border-[#D4AF37]/20 py-1.5 px-3 font-bold text-[10px] tracking-widest">14:00 GST</Badge>
                                </div>
                                <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5 group hover:border-[#D4AF37]/30 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-white group-hover:text-[#D4AF37] transition-colors">Lulu Hypermarket - Proforma</p>
                    ...
                    <Card className="bg-black/40 backdrop-blur-xl border border-white/10">
                        ...
                        <CardContent>
                            <div className="space-y-6">
                                <div className="border border-white/10 rounded-2xl p-6 bg-white/5 hover:border-[#D4AF37]/30 transition-all relative overflow-hidden group">
                                    ...
                                    <div className="flex justify-between items-start mb-6">
                                        <div>
                                            <h4 className="font-extrabold text-white text-lg group-hover:text-[#D4AF37] transition-colors">RFQ-2026-088: Copper Cathodes</h4>
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        ...
                                        <div className="bg-black/40 border border-[#D4AF37]/20 p-4 rounded-xl text-center shadow-[inset_0_0_15px_rgba(212,175,55,0.05)]">
                                            <div className="text-[#D4AF37] text-[10px] uppercase font-bold mb-1">Quotes</div>
                                            <div className="font-bold text-[#D4AF37] text-xl">4</div>
                                        </div>
                                        <div className="bg-black/40 border border-white/5 p-4 rounded-xl text-center">
                                    ...
                                    <Button variant="ghost" className="w-full mt-6 text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black font-bold uppercase tracking-widest text-[10px]">Analyze Quotes History &rarr;</Button>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
