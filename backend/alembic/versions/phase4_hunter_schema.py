...
def upgrade():
    ...
    op.create_table('hunter_leads',
        ...
        sa.Column('status', sa.Enum('new','enriched','qualified','rejected','pushed_to_crm', name='hunter_lead_status'), nullable=False, default='new'),
    ...
    op.create_table('hunter_lead_identities',
        ...
        sa.Column('type', sa.Enum('email','phone','domain','linkedin','address','other', name='hunter_identity_type'), nullable=False),
    ...
    op.create_table('hunter_enrichment_jobs',
        ...
        sa.Column('status', sa.Enum('queued','running','done','failed', name='hunter_enrichment_status'), nullable=False, default='queued'),
